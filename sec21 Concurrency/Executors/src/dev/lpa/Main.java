...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            isDone = blueExecutor.awaitTermination(500, TimeUnit.MICROSECONDS);
        ...
        try {
            isDone = yellowExecutor.awaitTermination(500, TimeUnit.MICROSECONDS);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            isDone = redExecutor.awaitTermination(500, TimeUnit.MICROSECONDS);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
