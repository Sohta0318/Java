...
//            System.out.println("Group1: " + htmlMatcher.group(1));
        ...
        htmlMatcher.reset();
        htmlMatcher.results().forEach(mr -> System.out.println(mr.group() + " " + mr.group(2)));
        ...
        tabbedText.lines().flatMap(
                s -> Pattern.compile("\\t").splitAsStream(s)).forEach(System.out::println);
        ...
        String replaceHTML = htmlMatcher.replaceAll((mr) -> "<em>" + mr.group(2) + "</em>");
        System.out.println("-".repeat(30));
