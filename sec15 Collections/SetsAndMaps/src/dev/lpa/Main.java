...
public class Main {
    public static void main(String[] args) {
        ...
        printData("(B ∩ A) Intersect of phones (V) with emails (A)", intersectBA);
        ...
        printData("Symmetric Differences: phones and emails", symmetricDiff);

        Set<Contact> symmetricDiff2 = new HashSet<>(unionAB);
        symmetricDiff2.removeAll(intersectAB);
        printData("Symmetric Differences: phones and emails", symmetricDiff2);
