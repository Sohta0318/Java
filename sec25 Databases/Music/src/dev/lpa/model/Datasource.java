...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/user/Desktop/Java/sec25 Databases/Music/" + DB_NAME;
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        // SELECT albums.name FROM album INNER JOIN artists ON albums.artist = artists._id WHERE artists.name = "Carole King" ORDER BY albums.name COLLATE NOCASE ASC
...
//        }
    ...
    private int insertArtist(String name) throws SQLException {
        ...
        if (results.next()) {
            ...
            int affectedRow = insertIntoArtists.executeUpdate();
            if (affectedRow != 1) {
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Couldn't rest auto-commit! " + e.getMessage());
            }
        }
