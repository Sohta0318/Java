...
public class Main {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/user/Desktop/Java/sec25 Databases/TestDB/" + DB_NAME;
    public static final String TABLE_CONTACTS = "contacts";
    public static final String COLUMN_NAME = "name";
    public static final String COLUMN_PHONE ="phone";
    public static final String COLUMN_EMAIL = "email";
    public static void main(String[] args) {
//        try(Connection conn = DriverManager.getConnection("jdbc:sqlite:/Users/user/Desktop/Java/sec25 Databases/TestDB/testjava.db");
...
//            conn.setAutoCommit(false);
            ...
            insertContact(statement,"Jane", 4829484, "tim@somewhere.com");
